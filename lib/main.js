...
const HydrogenPackage = {
  ...
  interruptKernel() {
    return kernelManager.interrupt(getEditor())
  },

  restartKernel() {
    return kernelManager.restart(getEditor())
  },

  shutdownKernel() {
    bubbleManager.clear(getEditor())
    return kernelManager.shutdown(getEditor())
  },

  renameWSKernel() {
    return kernelManager.renameWSKernel(getEditor())
  },

  disconnectKernel() {
    bubbleManager.clear(getEditor())
    return kernelManager.disconnect()
  },
