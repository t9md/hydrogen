...
import {URI_INSPECTOR, URI_WATCHES, URI_OUTPUT_AREA} from "./hydrogen-pane"
  ...
  registerCommands() {
    ...
    this.subscriptions.add(
      atom.commands.add("atom-text-editor:not([mini])", {
        ...
        // TODO
        "hydrogen:toggle-watches": () => atom.workspace.toggle(URI_WATCHES),
        "hydrogen:toggle-output-area": () => atom.workspace.toggle(URI_OUTPUT_AREA),
        ...
        //     atom.workspace.open(URI_WATCHES, {searchAllPanes: true})
        //   }
        // },
