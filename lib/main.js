  ...
  registerCommands() {
    this.subscriptions.add(
      atom.commands.add("atom-text-editor:not([mini])", {
        ...
        "hydrogen:run": () => this.getHydrogen().run(),
        "hydrogen:run-and-move-down": () => this.getHydrogen().run({moveDown: true}),
        "hydrogen:run-cell": () => this.getHydrogen().runCell(),
        "hydrogen:run-cell-and-move-down": () => this.getHydrogen().runCell({moveDown: true}),
        "hydrogen:run-all": () => this.getHydrogen().runAll(),
        "hydrogen:run-all-above": () => this.getHydrogen().runAllAbove(),
        "hydrogen:toggle-bubble": () => this.getHydrogen().toggleBubble(),
        "hydrogen:clear-results": () => this.getHydrogen().clearBubble(),
        "hydrogen:restart-kernel-and-re-evaluate-bubbles": () =>
          this.getHydrogen().restartKernelAndReEvaluateBubbles(),
        "hydrogen:interrupt-kernel": () => this.getHydrogen().interruptKernel(),
        "hydrogen:restart-kernel": () => this.getHydrogen().restartKernel(),
        "hydrogen:shutdown-kernel": () => this.getHydrogen().shutdownKernel(),
