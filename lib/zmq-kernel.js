...
export default class ZMQKernel extends Kernel {
  ...
  connect() {
    ...
    connectToKernel("shell", {
      ...
      port: this.connectionInfo.shell_port,
    })

    connectToKernel("control", {
      socketType: "dealer",
      identity: "control" + id,
      port: this.connectionInfo.control_port,
    })
    ...
    connectToKernel("stdin", {
      ...
      port: this.connectionInfo.stdin_port,
    })
    ...
    connectToKernel("io", {
      ...
      port: this.connectionInfo.iopub_port,
    })
    this.socketTable.io.subscribe("")

    return this.monitorConnect()
  }
