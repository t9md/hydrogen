...
export function renderMobxReactDevtools() {
  ...
  const element = mountComponent(<devTools.default noPanel />)
...
// Create div container element and render to container
// Return container element
export function mountComponent(component, containerClassList = []) {
  const element = document.createElement("div")

  element.classList.add("hydrogen")
  if (containerClassList.length) {
