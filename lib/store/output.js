...
const InterestingOutputTypes = ["execute_result", "display_data", "stream", "error"]
...
export default class OutputStore {
  ...
  isInterestingMessage(message) {
    return ["execute_result", "display_data", "stream", "error"].includes(message.output_type)
  }
